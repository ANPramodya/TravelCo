        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          >
            <div>
              <button
                onClick={scrollToTop}
                className="text-5xl font-lovers font-bold mb-2 hover:text-gray-300 transition-colors cursor-pointer text-left"
              >
                Avora Odyssey
              </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:hello@Avora Odyssey.com" className="text-gray-300 hover:text-white transition-colors">
                  hello@avoraodyssey.com
                </a>
              </div>
            </div>

            <p className="text-gray-400 text-sm pt-4 border-t border-gray-700">
              © {currentYear} Avora Odyssey. All rights reserved.
            </p>
          </motion.div>
